...
const Readbook = ({ book }) => {
  ...
  return (
    <div className="p-2 mb-5 border-2 lg:p-4 border-slate-400 rounded-2xl font-['Work_Sans']">
      <div className="flex flex-col gap-4 lg:flex-row lg:gap-5">
        ...
        <div>
          ...
          <div className="gap-8 lg:flex lg:gap-10">
            <div className="flex gap-3 my-1 lg:my-2">
          ...
          <div className="flex gap-5 pb-2 border-b-2 lg:pb-4 border-slate-400 ">
            <div className="flex gap-2">
              <img src={publish} alt="" />
          ...
          <div className="flex justify-between gap-3 mt-3 lg:justify-start lg:gap-5 lg:mt-5">
            <button className="px-2 text-[#328EFF] py-1 lg:px-5 lg:py-3 bg-[#328eff26] rounded-xl">
              Category: {category}
            </button>
